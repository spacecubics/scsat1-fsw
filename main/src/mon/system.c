...
LOG_MODULE_REGISTER(system_mon, CONFIG_SCSAT1_MAIN_LOG_LEVEL);
...
{
	k_timer_start(&system_monitor_timer, K_MSEC(CONFIG_SCSAT1_MAIN_MON_SYSTEM_DELAY_MSEC),
		      K_MSEC(CONFIG_SCSAT1_MAIN_MON_SYSTEM_INTERVAL_MSEC));
}
